...
// var DEFAULT_URL = '6-8-unit1-digitallife101.pdf';
...
//#endif
        ...
        loadingIndicator.textContent = mozL10n.get('loading_error_indicator',
          null, 'Sorry, we were unable to find the document at the original source. Verify that the document still exists.');
        var moreInfo = {
          message: message
        };
  ...
  this.update = function pageViewUpdate(scale, rotation) {
    ...
    // gooru changes
     ...
     if(pagestart > 1 && pagestart != ''){
 	 ...
 	 var thumbnail = "#thumbnailContainer" + i;
	 var generate = "#pageContainer" + i;
	$(generate).remove();
 	$(thumbnail).remove();
      }
      }
