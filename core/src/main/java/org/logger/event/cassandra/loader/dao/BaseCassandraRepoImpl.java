...
public class BaseCassandraRepoImpl extends BaseDAOCassandraImpl implements BaseCassandraRepo {
	...
	private final PreparedStatement INSERT_USER_SESSION = null;
	
	private final PreparedStatement INSERT_USER_LAST_SESSION = null;
	
	private final PreparedStatement INSERT_USER_SESSION_ACTIVITY = null;	
	
	private final PreparedStatement INSERT_STUDENTS_CLASS_ACTIVITY = null;
	
	private final PreparedStatement INSERT_CONTENT_TAXONOMY_ACTIVITY = null;	
	
	private final PreparedStatement INSERT_CONTENT_CLASS_TAXONOMY_ACTIVITY = null;
	
	private final PreparedStatement INSERT_USER_LOCATION = null;
	
	private final PreparedStatement UPDATE_PEER_COUNT = null;
...
//	private final PreparedStatement UPDATE_PEER_DETAILS_ON_STOP = getCassSession().prepare(Constants.UPDATE_PEER_DETAILS_ON_STOP);
	...
	private final PreparedStatement SELECT_USER_SESSION_ACTIVITY = null;
	
	private final PreparedStatement SELECT_USER_SESSION_ACTIVITY_BY_SESSION_ID = null;
	
	private final PreparedStatement SELECT_STUDENTS_CLASS_ACTIVITY = null;
	
	private final PreparedStatement UPDATE_REACTION = null;
	
	private final PreparedStatement UPDATE_SESSION_SCORE = null;
	
	private final PreparedStatement SELECT_CLASS_ACTIVITY_DATACUBE = null;
	
	private final PreparedStatement SELECT_ALL_CLASS_ACTIVITY_DATACUBE = null;
	
	private final PreparedStatement INSERT_CLASS_ACTIVITY_DATACUBE = null;
	
	private final PreparedStatement SELECT_TAXONOMY_PARENT_NODE = null;
	
	private final PreparedStatement SELECT_CONTENT_TAXONOMY_ACTIVITY = null;
	
	private final PreparedStatement SELECT_CONTENT_CLASS_TAXONOMY_ACTIVITY = null;
	
	private final PreparedStatement SELECT_TAXONOMY_ACTIVITY_DATACUBE = null;
	
	private final PreparedStatement INSERT_USER_QUESTION_GRADE = null;
	
	private final PreparedStatement SELECT_USER_QUESTION_GRADE_BY_SESSION = null;
	
	private final PreparedStatement SELECT_USER_QUESTION_GRADE_BY_QUESTION = null;
	
	private final PreparedStatement INSERT_TAXONOMY_ACTIVITY_DATACUBE = null;
	...
	public boolean saveUserSession(String sessionId,String classUid,String courseUid,String unitUid,String lessonUid,String collectionUid,String userUid,String collectionType, String eventType,long eventTime) {
		try {
			BoundStatement boundStatement = new BoundStatement(getUserSession(INSERT_USER_SESSION));
	...
	public boolean saveQuestionGradeInSession(String sessionId, String questionId, String collectionItemId, String status, long score) {
		try {			
			BoundStatement boundStatement = new BoundStatement(getUpdateSessionScore(UPDATE_SESSION_SCORE));
	...
	private PreparedStatement getUpdateSessionScore(PreparedStatement statement){
		if(statement == null){
			return getCassSession().prepare(Constants.UPDATE_SESSION_SCORE);
		}
		return statement;
	}
	
	private PreparedStatement getUserSession(PreparedStatement statement){		
		if(statement == null){
			return getCassSession().prepare(Constants.INSERT_USER_SESSION);
		}
		return statement;
	}
