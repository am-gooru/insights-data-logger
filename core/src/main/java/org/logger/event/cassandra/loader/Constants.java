...
public final class Constants {
	...
	public static final  Pattern SESSION_ACTIVITY_EVENTS_PATTERN = Pattern.compile("collection.play|collection.resource.play|reaction.create|resource.user.feedback");
	...
	public static final  Pattern COLLECTION_TYPES = Pattern.compile("collection|assessment|assessment/url");

	public static final  Pattern RESOURCE_FORMATS_PATTERN = Pattern.compile("resource|questions");

	public static final Pattern RECOMPUTATION_EVENTS_PATTERN =  Pattern.compile("item.delete|item.move");
