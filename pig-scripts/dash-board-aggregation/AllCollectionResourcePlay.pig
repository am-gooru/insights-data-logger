...
CRP_EVENTS = FILTER DUPLICATE_STAGE_VALUES   BY (event_id.value == 10) OR (event_id.value == 181) OR (event_id.value == 224) OR (event_id.value == 227);
