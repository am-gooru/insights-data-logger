...
GROUPED_REACTION_VALUES = GROUP REACTION_EVENTS by (parent_gooru_oid,gooru_oid,event_value,organization_uid);
...
AGG_HOURLY_REACTION_VALUES = FOREACH GET_REACTION_VALUES GENERATE StringConcat('R~',FLATTENED_REACTION_VALUES::REACTION_EVENTS::parent_gooru_oid.value,'~',FLATTENED_REACTION_VALUES::REACTION_EVENTS::gooru_oid.value) as key,TOTUPLE(StringConcat('R~RA~',DUPLICATE_REACTION_IDS::value),reaction_count) as reaction_count;
